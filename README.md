...
| Kuotes.ID | Create fullstack web app using nextjs 13 to create a social media for share about thoughts, developing REST API and manage database using MongoDB | [Repository](https://github.com/adrianuscharlie/Fullstack-NextJS13)
